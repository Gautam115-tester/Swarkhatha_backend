...
//
// IMPORTANT: application_id must be OMITTED entirely when no appId is
// configured — not sent as an empty string. MediaFire's parameter
// validator treats a present-but-blank application_id as malformed and
// rejects the whole request with 128 ERROR_MISSING_PARAMS ("Required
// parameters for this request are missing"), even though email+password
// alone is otherwise a valid, working login. This bit everyone who adds
// a MediaFire account without filling in the optional Advanced App
// ID/API Key fields in the admin app.
