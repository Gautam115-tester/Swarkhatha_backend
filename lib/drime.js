...
// a set of byte-range fragments. See lib/imageCache.js for the cache
// this feeds.
...
async function deleteFile({ accessToken, fileEntryId }) {
  const resp = await keepAliveClient.delete(`${BASE}/file-entries`, {
    headers: authHeaders(accessToken),
...
module.exports = { getLoggedUser, getSpaceUsage, uploadFile, getFileStream, getFileBuffer, deleteFile };
